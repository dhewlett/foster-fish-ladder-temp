...
colnames(foster_string_data)[4]<- "X10ft"
colnames(foster_string_data)[5]<- "X15ft"
colnames(foster_string_data)[6]<- "X20ft"
colnames(foster_string_data)[7]<- "X30ft"
colnames(foster_string_data)[8]<- "X40ft"
colnames(foster_string_data)[9]<- "X50ft"
colnames(foster_string_data)[10]<- "X5ft"
